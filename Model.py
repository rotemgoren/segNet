...
class UNetWithResNet50(nn.Module):
    ...
    def __init__(self, n_classes=2):
        ...
        base = torchvision.models.resnet.resnet50(pretrained=True)
        down_blocks = []
        up_blocks = []
        ...
        up_blocks.append(UpBlockForUNet(2048, 1024))
        up_blocks.append(UpBlockForUNet(1024, 512))
        up_blocks.append(UpBlockForUNet(512, 256))
        up_blocks.append(UpBlockForUNet(in_channels=128 + 64, out_channels=128,
